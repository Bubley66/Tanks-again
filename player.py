...
class Player:
    ...
    def draw(self, sur):
        ...
        pygame.draw.line(sur, WHITE, (int(c.real), int(c.imag)), (int(d.real), int(d.imag)), 10)
        ...
        pygame.draw.rect(sur, (102, 255, 102), (int(healthbar_pos.real), int(healthbar_pos.imag), self.health, 20))
